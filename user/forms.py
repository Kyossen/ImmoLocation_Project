...
class New_AdForm(forms.Form):
    """The ad form is a form to create a rental advertisement"""
    ...
    price_weeks = forms.CharField(
        label='PriceWeeks',
        max_length=255,
        required=True)

    price_day = forms.CharField(
        label='PriceDay',
        max_length=255,
        required=True)
    ...
    pics_1 = forms.ImageField(
        max_length=255,
        required=True)

    pics_2 = forms.ImageField(
        max_length=255,
        required=True)

    pics_3 = forms.ImageField(
        max_length=255,
        required=True)


class Rent_Now(forms.Form):
    """The ad form is a form to rent a rental"""
